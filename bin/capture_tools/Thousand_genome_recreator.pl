...
Synopsis:
	Thousand_genome_recreator.pl --sequence_index exome.index --population CEU --step download --cpu 10  --ftp ncbi	
	Thousand_genome_recreator.pl --sequence_index exome.index --population CEU --step join  --cpu 10
